            ...
            @forelse($customers as $customer)
                <div class="customer-item bg-white rounded-xl p-4 shadow-sm border border-gray-100 relative overflow-hidden">
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="swipe-actions absolute inset-y-0 right-0 flex items-center space-x-1 pr-4 bg-white rounded-xl">
                            <button
                                class="edit-btn w-10 h-10 bg-blue-500 text-white rounded-full flex items-center justify-center"
                            ...
                            <button
                                class="delete-btn w-10 h-10 bg-red-500 text-white rounded-full flex items-center justify-center"
