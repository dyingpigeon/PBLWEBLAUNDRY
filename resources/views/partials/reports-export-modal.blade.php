...
<div id="exportModal" class="fixed inset-0 bg-black bg-opacity-50 z-30 hidden">
    <div class="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl p-4">
        <div class="flex items-center justify-between mb-4">
            ...
            <button type="button" class="close-modal-btn p-2 text-gray-400 hover:text-gray-600" data-modal="exportModal">
        ...
        {{-- <div class="space-y-3">
            <button 
                type="button"
                class="export-format-btn w-full p-4 bg-white border border-gray-300 rounded-xl text-left flex items-center justify-between hover:bg-gray-50 transition-colors"
                data-format="pdf"
            >
            ...
            >
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Format data mentah</p>
                    </div>
                </div>
                <i class="fas fa-chevron-right text-gray-400"></i>
            </button>
