...
@push('scripts')
    <script>
        ...
        function selectCustomer(customer) {
            ...
            // showCustomerModal(); ← INI YANG BIKIN MASALAH
        }
        ...
        //                     // Escape karakter khusus untuk HTML
        //                     const safeName = service.name.replace(/'/g, "&#39;").replace(/"/g, "&quot;");
        //                     const safeDescription = (service.description || 'Layanan laundry').replace(/'/g, "&#39;").replace(/"/g, "&quot;");
        ...
        //                      onclick="selectServiceSafe(${service.id}, '${safeName}', '${safeDescription}', ${itemCount})">
        ...
        function selectServiceSafe(id, name, description, itemCount) {
            const service = {
                ...
                items: [] // Akan di-load terpisah jika diperlukan
            };
        ...
        //         container.innerHTML = '<p class="text-center text-gray-500">Tidak ada items tersedia untuk layanan ini</p>';
        //         return;
        //     }

        //     const items = transactionData.service.items;
        ...
        `;
            ...
            try {
                ...
                const response = await fetch('{{ route("transactions.getServices") }}', {
                    method: 'POST',
                    body: formData
                });
